 ...
 */
class Version20171114112024 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $table->addColumn('department_id', 'string', ['notnull' => true, 'length' =>128]);
        $table->addColumn('templates_id', 'string', ['notnull' => true, 'length' =>128]);
