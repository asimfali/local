...
class Article extends \Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entity\\Article' . "\0" . 'id', '' . "\0" . 'Entity\\Article' . "\0" . 'title', '' . "\0" . 'Entity\\Article' . "\0" . 'article', '' . "\0" . 'Entity\\Article' . "\0" . 'shortArticle', '' . "\0" . 'Entity\\Article' . "\0" . 'isPublic', '' . "\0" . 'Entity\\Article' . "\0" . 'category', '' . "\0" . 'Entity\\Article' . "\0" . 'comments'];
        }
